...
from tests.test_order_ddt import MANUAL_ROOT_DIR
...
MANUAL_FEATURE_DIR = os.path.join(MANUAL_ROOT_DIR, "Order")
AI_DATA_DIR = os.path.join(DATA_ROOT_DIR, "ai_processed", "order")
